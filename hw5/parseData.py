...
def read_data(dataPath = './data/train.csv'):
    # MAX_USERID: 6040
    # MAX_MOVIEID: 3952
...
def read_test_data(dataPath = './data/test.csv'):
    test_data = pd.read_csv('./data/test.csv', usecols = ['UserID', 'MovieID'])
    recommendations = pd.read_csv('./data/test.csv', usecols = ['TestDataID'])
